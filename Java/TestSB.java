 ...
 */
public class TestSB extends MiniGenBankSeq {
    public static void main(String[] args) {
        //long elapsedTime = System.nanoTime();
        StringBuilderMiniGenBankSeq sBuilderTest = new StringBuilderMiniGenBankSeq();
        System.out.println("Elapsed time: " + sBuilderTest.testConcatenate(100));
    }
}
